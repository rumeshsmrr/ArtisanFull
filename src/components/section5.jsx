    ...
    return (
        <section className="section5-back">
            ...
            <div 
                    ...
                    ref={textRef}>
                    <h2>Carefully Handpicked<br/> from Across the Island.</h2>
                    <p>There’s a broad range of designs, styles, and options to choose from when browsing antique furniture at Artisan Antique’s showroom located at Nawala. These unique pieces are carefully handpicked by our experts from across the island including Moratuwa, Galle, Bentota and Jaffna which emerged as important centres for furniture making from the 17th century onwards.
                    </p>
            </div>

                <div 
                    className={`squareo ${isSquareVisible ? 'fade-in' : ''}`} ref={squareRef}>
                </div>
