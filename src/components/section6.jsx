    ...
    return (
        <section className="section5-back">
            ...
            <div 
                    ...
                    <p>Your home isn’t just your living space but a true reflection of your personality and style. Let the authentic antique furniture finely curated by Artisan Antique elevate your home to  narrate the story of  true Sri Lankan artistic legacy. 

                    </p>
            </div>

            <div 
                className={`square1 ${isSquareVisible ? 'fade-in' : ''}`} ref={squareRef}>
            </div>
